...
FUN_PRINT = ft_printf.c check_flags.c ft_convert_hexa.c  display_d.c display_c.c \
			...
			ft_atoa.c display_p.c ft_convert_memory.c ft_put_precision.c ft_put_precision_char.c
...
OBJS_PRINT = ft_printf.o check_flags.o ft_convert_hexa.o display_d.o display_c.o \
			...
			ft_atoa.o display_p.o ft_convert_memory.o ft_put_precision.o ft_put_precision_char.o
