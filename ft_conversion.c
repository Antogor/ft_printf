...
/*   Updated: 2020/01/10 11:20:04 by agarzon-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_conversion(t_printf *tab)
{
	ft_asig(tab);
	if (tab->type == 'd' || tab->type == 'i')
		tab->d == 0 && tab->precision == 0 ? display_0(tab) :
		display_d(tab->d, tab);
	else if (tab->type == 'c')
		display_c(tab->c, tab);
	else if (tab->type == 's')
		...
		tab->u == 0 && tab->precision == 0 ? display_0(tab) :
		display_u(tab->u, tab);
	else if (tab->type == 'x' || tab->type == 'X')
		tab->hexa == 0 && tab->precision == 0 ? display_0(tab) :
